<template>
      ...
      <ul class="menu-items">
        <li class="menu-item-link">
          <div class="flex items-center">
            ...
            <router-link class="text-sm ml-2" to="/">Dashboard</router-link>
          </div>
        </li>
        <li class="menu-item-link">
          <div class="flex items-center">
      ...
      <div class="profile absolute bottom-2">
        <div class="flex items-center mt-4 mb-4 px-8">
          ...
          <div class="text-red-200">
            ...
            <p class="text-s hover:underline"><a target="_blank" href="https://github.com/IIWolfieII">View Profile</a>
            </p>
          </div>
        </div>
      </div>
    </div>
    <div class="bottom-menu px-4 bg-red-800">
      <ul class="w-full flex items-center justify-between">
        <li class="bottom-menu-link">
  ...
  <div
      class="w-64 z-40 absolute sm:relative bg-red-800 shadow md:h-full flex-col justify-between sm:hidden transition duration-150 ease-in-out"
      id="mobile-nav">
    <div id="openSideBar"
